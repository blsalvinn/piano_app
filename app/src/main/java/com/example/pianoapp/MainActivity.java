...
public class MainActivity extends AppCompatActivity {
    ...
    View d1, d2, d3, d4, d5, d7,d6, d9,d10, d11, d12;
    View t1, t2, t3, t4, t5, t8, t7, t9;
    Switch AdsSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mD1 = MediaPlayer.create(this, R.raw.f);
        mD2 = MediaPlayer.create(this, R.raw.g);
        mD3 = MediaPlayer.create(this, R.raw.a);
        mD4 = MediaPlayer.create(this, R.raw.b);
        mD5 = MediaPlayer.create(this, R.raw.c);
        mD6 = MediaPlayer.create(this, R.raw.d);
        mD7 = MediaPlayer.create(this, R.raw.e);
        mD8 = MediaPlayer.create(this, R.raw.f);
        mD9 = MediaPlayer.create(this, R.raw.g);
        mD10 = MediaPlayer.create(this, R.raw.a);
        mD11 = MediaPlayer.create(this, R.raw.b);
        mD12 = MediaPlayer.create(this, R.raw.c);

        mT1 = MediaPlayer.create(this, R.raw.f_hash);
        mT2 = MediaPlayer.create(this, R.raw.g_hash);
        mT3 = MediaPlayer.create(this, R.raw.a_hash);
        mT4 = MediaPlayer.create(this, R.raw.c_hash);
        mT5 = MediaPlayer.create(this, R.raw.d_hash);
        mT6 = MediaPlayer.create(this, R.raw.a);
        mT7 = MediaPlayer.create(this, R.raw.f_hash);
        mT8 = MediaPlayer.create(this, R.raw.g_hash);
        mT9 = MediaPlayer.create(this, R.raw.a_hash);
        ...
        d3.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                new CountDownTimer(1*100,100){
                    ...
                    @Override
                    public void onTick(long millisUntilFinished) {
                        String.valueOf(millisUntilFinished/10);
                    }
